"""
Script para generar el archivo nombres.py completo
"""

# Ruta del archivo
ruta = r"C:\Users\halco\Desktop\Proyectos\lastadventurer\backend\src\systems\nombres.py"
...
class NombreGenerator:
    ...
    APELLIDOS = [
        ...
        "O'Brien", "O'Connor", "O'Neill", "O'Sullivan", "O'Reilly", "O'Donovan", "O'Malley", "O'Doherty", "O