...
CONFIG_UBICACION = {
    ...
    TipoUbicacion.CAPITAL: {
        ...
        "npcs_min": 200,
        "npcs_max": 500,
        "servicios": ["tienda", "herrero", "posada", "templo", "banco", "gremio", "palacio"],
        "segura": True,
    },
...
class UbicacionGenerator:
    ...
    PREFIJOS = {
        TipoUbicacion.PUEBLO: ["Aldea", "Pueblo", "Caserío", "Hamlet", "Villa"],
        TipoUbicacion.CIUDAD: ["Ciudad", "Fortaleza", "Puerto", "Villa"],
        TipoUbicacion.CAPITAL: ["Capital", "Metrópolis", "Ciudadela"],
        TipoUbicacion.MAZMORRA: ["Cueva", "Ruinas", "Mazmorra", "Cripta", "Templo"],
        TipoUbicacion.POI: ["Santuario", "Monolito", "Fuente", "Árbol", "Piedra"],
    }
    
    ADJETIVOS = [
        "Antiguo", "Olvidado", "Sagrado", "Maldito", "Eterno",
        "Sombrío", "Luminoso", "Helado", "Ardiente", "Verde",
        "Dorado", "Plateado", "Carmesí", "Azul", "Negro"
    ]
    
    SUSTANTIVOS = {
        TipoUbicacion.PUEBLO: ["del Roble", "del Río", "de la Colina", "del Bosque", "del Valle"],
        TipoUbicacion.CIUDAD: ["de Plata", "del Hierro", "de la Luz", "de las Tormentas", "del Mar"],
        TipoUbicacion.CAPITAL: ["de los Reyes", "Imperial", "del Trono", "Eterna"],
        TipoUbicacion.MAZMORRA: ["de los Caídos", "del Destino", "de las Sombras", "del Dragón"],
        TipoUbicacion.POI: ["de los Deseos", "del Viento", "de la Luna", "del Sol"],
    }
