    ...
    <AnimatePresence mode="wait">
      {isOpen && (
        <motion.aside
          ...
          animate={{ width: "100%", maxWidth: "28rem", opacity: 1 }}
          exit={{ width: 0, opacity: 0 }}
          transition={{ type: "spring", stiffness: 300, damping: 30 }}
          className="h-full bg-[#0a0a0f] border-r border-[#d4a843]/30 flex-shrink-0 overflow-hidden relative shadow-[10px_0_50px_rgba(0,0,0,0.5)] z-50"
        >
          {/* Header decorativo */}
          <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-[#d4a843] to-transparent opacity-50" />

          <div className="p-8 h-full flex flex-col min-w-[28rem] overflow-y-auto custom-scrollbar">
            {/* Header */}
            <div className="flex justify-between items-center mb-10">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h2 className="font-medieval p-4 text-2xl text-[#d4a843] leading-none mb-1">
                    Personaje
                  </h2>
