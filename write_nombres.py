"""
Script para escribir el archivo nombres.py completo
"""

import os

# Ruta del archivo
ruta_archivo = r"C:\Users\halco\Desktop\Proyectos\lastadventurer\backend\src\systems\nombres.py"

# Contenido del archivo - Parte 1
parte1 = '''"""
...
class NombreGenerator:
    ...
    APELLIDOS = [
        ...
        "O'Brien", "O'Connor", "O'Neill", "O'Sullivan", "O'Re